...
const pilaresMainContent = `
    <div class="container-margin" style="margin-bottom: 25px;">
        <p class="text-base" style="text-align: center; font-size: 1.1rem;">Para explorar os detalhes dos três pilares e seus processos, clique nas caixas abaixo.</p>
    </div>
...
const iniciativasData = {
    requalificacao: { title: "Requalificação de Vias", description: "Programa abrangente de melhoria da infraestrutura viária, incluindo pavimentação, sinalização e drenagem das vias urbanas e rurais dos municípios consorciados.", detalhes: ["Pavimentação asfáltica de vias urbanas", "Implementação de sistema de drenagem", "Sinalização horizontal e vertical", "Construção de calçadas acessíveis"] },
    manutencao: { title: "Manutenção de Vias", description: "Serviços contínuos de conservação e manutenção das vias públicas para garantir sua durabilidade e segurança.", detalhes: ["Tapa-buracos e remendos", "Limpeza de bueiros e galerias", "Manutenção da sinalização", "Roçagem de canteiros centrais"] },
    cadeias: { title: "Fortalecimento de Cadeias Produtivas Rurais", description: "Apoio técnico e financeiro para o desenvolvimento e fortalecimento das cadeias produtivas do setor agropecuário.", detalhes: ["Assistência técnica rural", "Capacitação de produtores", "Apoio à comercialização", "Desenvolvimento de cooperativas"] },
    hidrica: { title: "Ampliação da Oferta Hídrica", description: "Construção e melhoria de infraestruturas hídricas para garantir o acesso à água de qualidade para a população e atividades produtivas.", detalhes: ["Perfuração de poços artesianos", "Construção de cisternas", "Sistemas de abastecimento", "Tratamento de água"] },
    qualificacao: { title: "Qualificação de Produtos", description: "Programas de melhoria da qualidade e certificação de produtos de origem animal e vegetal produzidos na região.", detalhes: ["Certificação sanitária", "Controle de qualidade", "Rastreabilidade de produtos", "Adequação às normas técnicas"] },
    fundiaria: { title: "Regularização Fundiária", description: "Suporte técnico e jurídico para a regularização de propriedades rurais e urbanas, garantindo segurança jurídica aos proprietários.", detalhes: ["Levantamento topográfico", "Documentação legal", "Georreferenciamento", "Registro de imóveis"] },
    ambiental: { title: "Gestão Ambiental", description: "Suporte técnico especializado para fortalecer a gestão ambiental nos municípios consorciados, promovendo sustentabilidade e conformidade com a legislação.", detalhes: ["Elaboração de planos ambientais", "Suporte ao licenciamento ambiental", "Programas de educação ambiental", "Monitoramento de recursos naturais"] },
    infraestrutura: { title: "Obras de Infraestrutura", description: "Execução consorciada de obras de infraestrutura urbana e construção ou reforma de edificações públicas essenciais para os serviços municipais.", detalhes: ["Construção de escolas e postos de saúde", "Reforma de praças e espaços públicos", "Construção de mercados municipais", "Edificação de centros administrativos"] },
    social: { title: "Educação, Cultura, Esporte e Turismo", description: "Desenvolvimento de programas e ações integradas para fortalecer as políticas sociais, valorizando a cultura local e promovendo o desenvolvimento regional.", detalhes: ["Programas educacionais complementares", "Fomento a eventos culturais regionais", "Melhoria da infraestrutura esportiva", "Criação de roteiros turísticos integrados"] },
    maquinas: { title: "Máquinas e Equipamentos", description: "Disponibilização e gerenciamento compartilhado de máquinas e equipamentos entre os municípios para otimizar recursos e viabilizar obras e serviços.", detalhes: ["Compartilhamento de máquinas pesadas", "Aquisição de equipamentos agrícolas", "Manutenção de frota compartilhada", "Sistema de agendamento online"] },
    habitacao: { title: "Obras de Habitação", description: "Desenvolvimento e execução de programas habitacionais consorciados para atender às necessidades de moradia digna da população.", detalhes: ["Construção de unidades habitacionais", "Programas de reforma de moradias", "Implantação de infraestrutura urbana", "Regularização de loteamentos"] },
    residuos: { title: "Gestão de Resíduos Sólidos", description: "Implementação de sistemas integrados e regionais para a gestão de resíduos sólidos, visando a sustentabilidade ambiental e a redução de custos.", detalhes: ["Implantação de coleta seletiva", "Construção de aterros sanitários regionais", "Fomento a programas de reciclagem", "Campanhas de educação ambiental"] },
    planos: { title: "Elaboração de Planos e Projetos", description: "Elaboração de planos estratégicos e projetos técnicos para orientar o desenvolvimento territorial e viabilizar a captação de recursos.", detalhes: ["Revisão de planos diretores municipais", "Elaboração de projetos para captação de recursos", "Realização de estudos de viabilidade técnica", "Desenvolvimento de planos setoriais integrados"] }
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeSearch(); 
    initializeShare();  
    initializeAccessibility(); // FUNÇÃO DE ACESSIBILIDADE
});
...
function initializeModals() {
    ...
    // Função auxiliar para lidar com Enter e Espaço
    ...
    function openObjetivoDetails(key) {
        if (objetivosData[key]) {
            ...
            const backBtnHtml = `
                <button id="btn-voltar-pilares" class="btn-voltar-moderno" aria-label="Voltar para Pilares">
                    <span class="icon-circle-voltar" aria-hidden="true">
    ...
    function openIniciativaDetails(key) {
        if (iniciativasData[key]) {
            ...
            const backBtnHtml = `
                <button id="btn-voltar-primarias" class="btn-voltar-moderno" aria-label="Voltar para Atividades Primárias">
                    <span class="icon-circle-voltar" aria-hidden="true">
                        <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"></path></svg>
                    </span>
            ...
            btnVoltarPrim.addEventListener('click', () => openCadeiaValorModal('primarias'));
            btnVoltarPrim.focus();
        }
    }
    ...
    addKeyboardSupport(document.querySelectorAll('.cv-card-trigger'), function() {
        ...
        if (cadeiaValorData[key]) openCadeiaValorModal(key);
    });
...
function initializeAccessibility() {
    ...
    // 3. Teclas de Atalho (Access Keys - Alt + Número)
